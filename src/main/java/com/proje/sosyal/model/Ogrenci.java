...
public class Ogrenci {
    ...
    @JsonIgnore // EKLENDİ: Mesajlaşırken gönderi listesini çekme
    ...
    private String rol = "USER"; // Varsayılan olarak herkes normal kullanıcı

    // Getter ve Setter (Eğer Lombok @Data varsa gerek yok, elle yazıyorsan ekle)
