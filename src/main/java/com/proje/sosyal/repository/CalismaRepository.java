...
public interface CalismaRepository extends JpaRepository<Calisma, Long> {
    ...
    List<Calisma> findByOgrenci(Ogrenci ogrenci); // Eski metod kalsın

    // YENİ: Bir öğrencinin toplam dakikasını hesapla
    // COALESCE(SUM(...), 0) demek: Eğer sonuç null ise (hiç çalışmadıysa) 0 döndür.
